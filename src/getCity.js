	...
	constructor(props){
		...
		this.state={
		 city:[
			...
			{city:'云南',town:[['昆明','kunming'],['红河','honghe'],['大理','dali'],['文山','wenshan'],['德宏','dehong'],['曲靖','qujing'],['昭通','zhaotong'],['楚雄','chuxiong'],['保山','baoshan'],['玉溪','yuxi'],['丽江','lijiang'],['临沧','lingcang'],['思茅','simao'],['西双版纳','xishuang'],['怒江','nujiang'],['迪庆','diqing']]},
			...
			{city:'安徽',town:[['芜湖','wuhu'],['合肥','hefei'],['六安','liuan'],['宿州','suzhou'],['阜阳','huyang'],['安庆','anqing'],['马鞍山','maanshan'],['蚌埠','fenghu'],['淮北','huaibei'],['淮南','huainan'],['宣城','xuancheng'],['黄山','huangshan'],['铜陵','tongling'],['亳州','haozhou'],['池州','chizhou'],['巢湖','chaohu'],['滁州','chuzhou']]},
			...
			{city:'新疆',town:[['乌鲁木齐','wulumuqi'],['伊犁','yili'],['昌吉','changji'],['石河子','shihezi'],['哈密','hami'],['阿克苏','akesu'],['喀什','kashi'],['塔城','tacheng'],['克拉玛依','kelamayi'],['和田','hetian'],['阿勒泰','aleta'],['吐鲁番','tulufan'],['阿拉尔','alaer'],['博尔塔拉','boertala'],['五家渠','wujiaqu'],['克孜勒苏','kezilesu'],['图木舒克','tumushuke']]},
			...
			{city:'内蒙古',town:[['赤峰','chifeng'],['包头','baotou'],['通辽','tongliao'],['临河','linhe'],['呼和浩特','huhehaote'],['乌海','wuhai'],['鄂尔多斯','eerduosi'],['海拉尔','hailaer'],['兴安','xinan'],['乌兰察布','wulanchabu'],['锡林浩特','xilinghaote'],['集宁','jining'],['阿左旗','azuoqi']]},
			{city:'陕西',town:[['西安','xian'],['咸阳','xianyang'],['三原','sanyuan'],['宝鸡','baoji'],['汉中','hanzhou'],['渭南','weinan'],['安康','ankang'],['榆林','yulin'],['商洛','shangluo'],['延安','yanan'],['铜川','tongchuan']]},
			...
			{city:'贵州',town:[['贵阳','guiyang'],['遵义','zunyi'],['兴义','xingyi'],['毕节','bijie'],['铜仁','tongren'],['安顺','anshun'],['六盘水','liupanshui']]},
